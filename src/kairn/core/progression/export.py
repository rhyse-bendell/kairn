...
def export_artifact_progression_package(db_path: str, analysis_run_id: str, out_dir: str) -> dict:
    ...
    paths={}
    paths['inclusion_csv']=str(out/'artifact_inclusion_manifest.csv'); _write_csv(Path(paths['inclusion_csv']), inc)
    ...
    paths['evidence_csv']=str(out/'artifact_evidence_units.csv'); _write_csv(Path(paths['evidence_csv']), ev)
    ...
    paths['candidates_csv']=str(out/'artifact_progression_candidates.csv'); _write_csv(Path(paths['candidates_csv']), cand)
    ...
    paths['matrix_long_csv']=str(out/'team_progression_matrix_long.csv'); _write_csv(Path(paths['matrix_long_csv']), matrix)
